...
themes_dir                          = os.getenv("HOME") .. "/.config/awesome/themes/dudw4r3z-bedtop-green"
theme.wallpaper                     = themes_dir .. "/cool.jpg"

theme.dud_col1						= "#125756"
theme.dud_col2						= "#26393f"

theme.download_col					= "#B796B5"
theme.upload_col					= "#46A8C3"

theme.widget_font_col				= "#AAAAAA"

theme.font                          = "Basis33 11"
