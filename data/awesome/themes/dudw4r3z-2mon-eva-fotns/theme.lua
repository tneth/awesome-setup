...
themes_dir                          = os.getenv("HOME") .. "/.config/awesome/themes/dudw4r3z-2mon-eva-fotns"
theme.wallpaper = function(s)
	papers = { "/hokuto_ken.jpg", "/eva.jpg" }
	return themes_dir .. papers[s.index]
end

theme.dud_col1						= "#000000" --"#0E0C0D"
theme.dud_col2						= "#2b4347" --"#26393f"

theme.download_col					= "#B796B5"
theme.upload_col					= "#46A8C3"

theme.widget_font_col				= "#FFFFFF"

theme.font                          = "Basis33 12"

theme.fg_normal                     = "#AAAAAA"
theme.fg_focus                      = "#F0DFAF"
theme.fg_urgent                     = "#B796B5"
theme.bg_normal                     = theme.dud_col1
theme.bg_focus                      = theme.dud_col2
theme.bg_urgent                     = theme.dud_col1
theme.border_width                  = "0"
theme.border_normal                 = "#000000"			-- unused
theme.border_focus                  = "#000000"			-- unused
theme.border_marked                 = "#000000"			-- unused
theme.titlebar_bg_focus             = "#555555"
theme.titlebar_bg_normal            = "#FF0000"
theme.taglist_fg_focus              = "#FFFFFF"
theme.tasklist_bg_focus             = theme.dud_col1
theme.tasklist_fg_focus             = "#FFFFFF"
theme.textbox_widget_margin_top     = 2
theme.notify_fg                     = theme.fg_normal
theme.notify_bg                     = theme.bg_normal
theme.notify_border                 = theme.border_focus
theme.awful_widget_height           = 2
